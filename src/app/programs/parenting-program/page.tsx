...
const ServicePage: React.FC = () => {
  return (
    <div className="min-h-screen text-gray-700 pt-32 md:pt-32 bg-pink-50">
      <section className="relative h-[45vh] w-full bg-[#0e305e] text-white px-6 py-6 md:py-10 flex flex-col md:flex-row items-center justify-between">
        <div className="max-w-2xl text-center md:text-left">
          ...
          <p className="text-3xl md:text-5xl font-bold mb-4">Our Program &</p>
    ...
    Building Life Skills for Enhanced Independence
  </h2>

                <div className="space-y-4">
                <p className="text-gray-600 leading-relaxed">
      Our ADL (Activities of Daily Living) Program empowers individuals to achieve greater independence through personalized skill development. We focus on essential daily tasks, from self-care to home management, ensuring each participant gains confidence and capability.
    </p>
  
    <h3 className="text-2xl font-bold text-[#0e305e]">Program Components</h3>
    <ul className="list-disc ml-6 text-gray-600 space-y-4">
      <li className="leading-loose">
        <span className="font-semibold">Personalized Sessions:</span> Weekly one-on-one training with skilled professionals
      </li>
      <li className="leading-loose">
        <span className="font-semibold">Skill Building:</span> Practical activities focused on daily living tasks
      </li>
      <li className="leading-loose">
        <span className="font-semibold">Community Integration:</span> Real-world application of learned skills
      </li>
    </ul>
</div>
              ...
              <div className="space-y-4">
      <h2 className="text-2xl font-bold text-[#0e305e]">Core Focus Areas</h2>
      <ul className="space-y-4 bg-gray-50 p-6 rounded-lg">
        <li className="flex items-start">
          <span className="shrink-0 mt-1 mr-3 text-teal-600">●</span>
          <p className="text-gray-600 leading-relaxed">
            <span className="font-semibold">Self-Care Skills:</span> Personal hygiene, grooming, and health management
          </p>
        </li>
        <li className="flex items-start">
          <span className="shrink-0 mt-1 mr-3 text-teal-600">●</span>
          <p className="text-gray-600 leading-relaxed">
            <span className="font-semibold">Home Management:</span> Cooking, cleaning, and household organization
          </p>
        </li>
        <li className="flex items-start">
          <span className="shrink-0 mt-1 mr-3 text-teal-600">●</span>
          <p className="text-gray-600 leading-relaxed">
            <span className="font-semibold">Life Skills:</span> Financial management, time management, and social skills
          </p>
        </li>
      </ul>
    </div>
<div className="space-y-4">
  ...
  <ul className="space-y-4 p-6">
        <li className="flex items-start">
          <span className="shrink-0 mt-1 mr-3 text-teal-600">●</span>
          <p className="text-gray-600 leading-relaxed">
            <span className="font-semibold">Task Analysis</span>{" "}
            Breaking down complex activities into manageable steps for easier learning
          </p>
        </li>
        <li className="flex items-start">
          <span className="shrink-0 mt-1 mr-3 text-teal-600">●</span>
          <p className="text-gray-600 leading-relaxed">
            ...
            Guided practice sessions in real-life settings
          </p>
        </li>
        <li className="flex items-start">
          <span className="shrink-0 mt-1 mr-3 text-teal-600">●</span>
          <p className="text-gray-600 leading-relaxed">
            ...
            Regular assessment and adjustment of goals based on individual progress
          </p>
        </li>
      </ul>
</div>
