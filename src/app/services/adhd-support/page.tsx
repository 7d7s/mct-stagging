...
const ServicePage: React.FC = () => {
  ...
  <p className="text-gray-600 leading-relaxed">
    ADHD support services focus on providing strategies and techniques to help children with Attention Deficit Hyperactivity Disorder (ADHD) thrive. This includes behavioral therapy, focus improvement, and family support to help manage symptoms.
  </p>
  
  <h3 className="text-2xl font-bold text-[#0e305e]">Benefits of ADHD Support</h3>
  <ul className="list-disc ml-6 text-gray-600 space-y-4">
    <li className="leading-loose">
      <span className="font-semibold">Improved Focus:</span> Strategies and techniques to help children with ADHD improve their attention span and ability to stay on task.
    </li>
    <li className="leading-loose">
      <span className="font-semibold">Behavioral Management:</span> Techniques to help manage impulsive behaviors and teach children better self-control and emotional regulation.
    </li>
    <li className="leading-loose">
      <span className="font-semibold">Support for Families:</span> Providing tools and support for families to help their children with ADHD succeed both at home and at school.
    </li>
  </ul>
</div>
  ...
  <p className="text-gray-600 leading-relaxed">
    Understanding the signs and symptoms of ADHD is crucial for early intervention and effective support.
  </p>
  <ul className="space-y-4 bg-gray-50 p-6 rounded-lg">
    <li className="flex items-start">
      <span className="shrink-0 mt-1 mr-3 text-teal-600">●</span>
      <p className="text-gray-600 leading-relaxed">
        <span className="font-semibold">Attention Difficulties:</span>{" "}
        Trouble focusing on tasks, easily distracted, difficulty following instructions, and organizational challenges.
      </p>
    </li>
    <li className="flex items-start">
      <span className="shrink-0 mt-1 mr-3 text-teal-600">●</span>
    ...
    <li className="flex items-start">
      <span className="shrink-0 mt-1 mr-3 text-teal-600">●</span>
      <p className="text-gray-600 leading-relaxed">
        <span className="font-semibold">Impulsivity:</span>{" "}
        Acting without thinking, interrupting others, difficulty waiting their turn, and making hasty decisions.
      </p>
    </li>
  </ul>
</div>
