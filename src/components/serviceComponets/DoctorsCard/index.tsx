...
const DoctorCard = () => {
  return (
    <div className="bg-white shadow-sm border p-5 max-w-sm md:max-w-3xl flex flex-col md:flex-row lg:space-x-5">
      {/* Doctor Image Section */}
      <div className="relative overflow-hidden border w-full md:w-1/4">
        <Image
      ...
      <div className="w-full md:w-2/3 p-2">
        ...
        <div className="mt-4 flex gap-4">
          <button className="bg-[#0e305e] text-white text-sm p-3 sm:px-7 hover:bg-[#0e305e]">
            Schedule appointment
          </button>
          <button className="text-sm border border-gray-400 p-3 sm:px-7 hover:bg-gray-100">
            View Profile
          </button>
        </div>
      </div>
